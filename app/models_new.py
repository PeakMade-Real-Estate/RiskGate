"""
Database models for SecurityScan - Microsoft Entra Identity Monitoring.

SecurityScan ingests and correlates Microsoft Entra sign-in logs, audit logs,
...
SecurityScan is a monitoring and alerting layer.
"""
